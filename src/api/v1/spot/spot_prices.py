...
from src.models import SpotPricesModel, Message
...
async def get_currency(request: Request, currency: str) -> Union[SpotPricesModel, JSONResponse]:
    ...
    if not spot_prices:
        return JSONResponse(status_code=404, content={"message": "Provided currency wasn't found"})
